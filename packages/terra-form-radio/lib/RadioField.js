...
var _RadioFieldModule = require('./RadioField.module.scss');

var _RadioFieldModule2 = _interopRequireDefault(_RadioFieldModule);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

function _objectWithoutProperties(obj, keys) { var target = {}; for (var i in obj) { if (keys.indexOf(i) >= 0) continue; if (!Object.prototype.hasOwnProperty.call(obj, i)) continue; target[i] = obj[i]; } return target; }

var cx = _bind2.default.bind(_RadioFieldModule2.default);
...
var RadioField = function RadioField(props, _ref) {
  var intl = _ref.intl;
  ...
  var radioFieldClasses = cx(['radio-field', { 'is-inline': isInline }, customProps.className]);
  ...
  return _react2.default.createElement(
    'fieldset',
    _extends({}, customProps, { className: radioFieldClasses }),
    legendGroup,
    children,
