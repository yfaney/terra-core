...
var TextareaField = function TextareaField(props) {
  var defaultValue = props.defaultValue,
      ...
      value = props.value,
      customProps = _objectWithoutProperties(props, ['defaultValue', 'error', 'errorIcon', 'help', 'hideRequired', 'inputAttrs', 'inputId', 'isInline', 'isInvalid', 'isLabelHidden', 'label', 'labelAttrs', 'required', 'showOptional', 'onChange', 'value']);
  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement(_Textarea2.default, _extends({}, inputAttrs, {
      id: inputId,
      onChange: onChange,
      value: value,
