...
var RowsOnKeyDown = function (_React$Component) {
  _inherits(RowsOnKeyDown, _React$Component);

  function RowsOnKeyDown() {
    _classCallCheck(this, RowsOnKeyDown);

    var _this = _possibleConstructorReturn(this, (RowsOnKeyDown.__proto__ || Object.getPrototypeOf(RowsOnKeyDown)).call(this));

    _this.onKeyDown = _this.onKeyDown.bind(_this);
    _this.clickedText = 'key pressed on body';
    return _this;
  }

  _createClass(RowsOnKeyDown, [{
    key: 'onKeyDown',
  ...
  return RowsOnKeyDown;
}(_react2.default.Component);

exports.default = RowsOnKeyDown;