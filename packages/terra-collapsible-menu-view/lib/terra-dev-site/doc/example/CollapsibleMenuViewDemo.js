...
var _CollapsibleMenuView = require('terra-collapsible-menu-view/lib/CollapsibleMenuView');
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(_CollapsibleMenuView2.default.Item, {
          ...
          isDisabled: true,
          shouldCloseOnClick: false,
          subMenuItems: [_react2.default.createElement(_CollapsibleMenuView2.default.Item, { text: 'Default Item 1', key: 'defaultItem1' }), _react2.default.createElement(_CollapsibleMenuView2.default.Item, { text: 'Default Item 2', key: 'defaultItem2', isDisabled: true })]
        }),
        ...
        _react2.default.createElement(
          ...
          { key: 'ViewTypeSelection', selectedKeys: [this.state.displayType], onChange: this.handleDisplayTypeChange },
          _react2.default.createElement(_CollapsibleMenuView2.default.Item, {
        ...
        _react2.default.createElement(_CollapsibleMenuView2.default.Item, { icon: _react2.default.createElement(_IconSend2.default, null), text: 'Send Message', key: 'send', isIconOnly: true }),
        _react2.default.createElement(
          _CollapsibleMenuView2.default.ItemGroup,
          { key: 'messageActionGroup' },
          _react2.default.createElement(_CollapsibleMenuView2.default.Item, { icon: _react2.default.createElement(_IconPrinter2.default, null), text: 'Print Message', key: 'print', isIconOnly: true }),
          _react2.default.createElement(_CollapsibleMenuView2.default.Item, { icon: _react2.default.createElement(_IconFolder2.default, null), text: 'Move Message to Folder...', key: 'move', isIconOnly: true, isDisabled: true }),
          _react2.default.createElement(_CollapsibleMenuView2.default.Item, { icon: _react2.default.createElement(_IconTrash2.default, null), text: 'Trash Message', key: 'trash', isIconOnly: true })
        ),
        _react2.default.createElement(_CollapsibleMenuView2.default.Divider, { key: 'Divider4' }),
        _react2.default.createElement(_CollapsibleMenuView2.default.Item, { text: 'Button 1', key: 'button1' }),
        _react2.default.createElement(_CollapsibleMenuView2.default.Item, { text: 'Button 2', key: 'button2', isDisabled: true }),
        _react2.default.createElement(_CollapsibleMenuView2.default.Item, { text: 'Button 3', key: 'button3' }),
        _react2.default.createElement(_CollapsibleMenuView2.default.Item, { text: 'Button 4', key: 'button4' })
      );
    }
  }]);
