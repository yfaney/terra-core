...
var DisabledExample = function (_React$Component) {
  ...
  function DisabledExample(props) {
    ...
    var _this = _possibleConstructorReturn(this, (DisabledExample.__proto__ || Object.getPrototypeOf(DisabledExample)).call(this, props));

    _this.state = { input: 'Disabled Example input' };
