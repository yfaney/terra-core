...
var SelectableMenu = function (_React$Component) {
  _inherits(SelectableMenu, _React$Component);

  function SelectableMenu(props) {
    _classCallCheck(this, SelectableMenu);

    var _this = _possibleConstructorReturn(this, (SelectableMenu.__proto__ || Object.getPrototypeOf(SelectableMenu)).call(this, props));
  ...
  _createClass(SelectableMenu, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'button',
          { type: 'button', id: 'selectable-menu-button', onClick: this.handleButtonClick, ref: this.setButtonNode },
          'Default Menu'
        )
      );
    }
