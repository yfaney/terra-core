...
var ButtonGroupSingleSelect = function (_React$Component) {
  ...
  function ButtonGroupSingleSelect(props) {
    ...
    _this.state = { selectedKey: ['single-select1'] };
  ...
  _createClass(ButtonGroupSingleSelect, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(_ButtonGroup2.default.Button, { text: 'Single-Select 1', key: 'single-select1' }),
        _react2.default.createElement(_ButtonGroup2.default.Button, { text: 'Single-Select 2', key: 'single-select2' }),
        _react2.default.createElement(_ButtonGroup2.default.Button, { text: 'Single-Select 3', key: 'single-select3' })
      );
    }
  }]);
