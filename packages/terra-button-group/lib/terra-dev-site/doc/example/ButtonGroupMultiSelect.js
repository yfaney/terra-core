...
var ButtonGroupMultiSelect = function (_React$Component) {
  ...
  function ButtonGroupMultiSelect(props) {
    ...
    _this.state = { selectedKeys: ['multi-select1', 'multi-select3'] };
  ...
  _createClass(ButtonGroupMultiSelect, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(_ButtonGroup2.default.Button, { text: 'Multi-Select 1', key: 'multi-select1' }),
        _react2.default.createElement(_ButtonGroup2.default.Button, { text: 'Multi-Select 2', key: 'multi-select2' }),
        _react2.default.createElement(_ButtonGroup2.default.Button, { text: 'Multi-Select 3', key: 'multi-select3' })
      );
    }
  }]);
