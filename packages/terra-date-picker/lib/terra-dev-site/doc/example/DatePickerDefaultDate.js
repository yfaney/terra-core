...
var DatePickerExampleDefaultDate = function DatePickerExampleDefaultDate() {
  return _react2.default.createElement(DatePickerExample, { selectedDate: (0, _moment2.default)().format() });
};

exports.default = DatePickerExampleDefaultDate;