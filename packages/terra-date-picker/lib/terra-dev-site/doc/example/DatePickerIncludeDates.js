...
var DatePickerExampleIncludeDates = function DatePickerExampleIncludeDates() {
  return _react2.default.createElement(DatePickerExample, {
    includeDates: [(0, _moment2.default)().format(), (0, _moment2.default)().subtract(1, 'days').format(), (0, _moment2.default)().add(1, 'days').format()]
  });
};

exports.default = DatePickerExampleIncludeDates;