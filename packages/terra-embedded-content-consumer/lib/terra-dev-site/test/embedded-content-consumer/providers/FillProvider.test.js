...
var FillProvider = function (_React$Component) {
  _inherits(FillProvider, _React$Component);

  function FillProvider() {
    _classCallCheck(this, FillProvider);

    return _possibleConstructorReturn(this, (FillProvider.__proto__ || Object.getPrototypeOf(FillProvider)).apply(this, arguments));
  }

  _createClass(FillProvider, [{
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            'p',
            null,
            'This page simulates the situation where the embedded content consumer expands into the parent.'
          )
        )
      );
    }
