...
var AbstractModalCloseOnOutsideClick = function (_React$Component) {
  _inherits(AbstractModalCloseOnOutsideClick, _React$Component);

  function AbstractModalCloseOnOutsideClick() {
    _classCallCheck(this, AbstractModalCloseOnOutsideClick);

    var _this = _possibleConstructorReturn(this, (AbstractModalCloseOnOutsideClick.__proto__ || Object.getPrototypeOf(AbstractModalCloseOnOutsideClick)).call(this));
  ...
  _createClass(AbstractModalCloseOnOutsideClick, [{
    key: 'handleOpenModal',
...
exports.default = AbstractModalCloseOnOutsideClick;