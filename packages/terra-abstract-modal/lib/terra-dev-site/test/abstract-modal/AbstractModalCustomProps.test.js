...
var ModalCustomProps = function (_React$Component) {
  _inherits(ModalCustomProps, _React$Component);

  function ModalCustomProps() {
    _classCallCheck(this, ModalCustomProps);

    var _this = _possibleConstructorReturn(this, (ModalCustomProps.__proto__ || Object.getPrototypeOf(ModalCustomProps)).call(this));
  ...
  return ModalCustomProps;
}(_react2.default.Component);

exports.default = ModalCustomProps;