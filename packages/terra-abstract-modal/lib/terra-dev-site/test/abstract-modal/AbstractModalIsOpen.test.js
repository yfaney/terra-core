...
var ModalIsOpen = function (_React$Component) {
  _inherits(ModalIsOpen, _React$Component);

  function ModalIsOpen() {
    _classCallCheck(this, ModalIsOpen);

    var _this = _possibleConstructorReturn(this, (ModalIsOpen.__proto__ || Object.getPrototypeOf(ModalIsOpen)).call(this));
