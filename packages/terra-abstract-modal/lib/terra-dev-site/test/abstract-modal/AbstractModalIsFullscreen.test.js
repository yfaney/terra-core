...
var ModalIsFullscreen = function (_React$Component) {
  _inherits(ModalIsFullscreen, _React$Component);

  function ModalIsFullscreen() {
    _classCallCheck(this, ModalIsFullscreen);

    var _this = _possibleConstructorReturn(this, (ModalIsFullscreen.__proto__ || Object.getPrototypeOf(ModalIsFullscreen)).call(this));
  ...
  _createClass(ModalIsFullscreen, [{
    key: 'handleOpenModal',
...
exports.default = ModalIsFullscreen;