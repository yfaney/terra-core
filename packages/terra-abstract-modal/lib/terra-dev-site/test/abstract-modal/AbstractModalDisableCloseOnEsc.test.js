...
var ModalDisableCloseOnEsc = function (_React$Component) {
  _inherits(ModalDisableCloseOnEsc, _React$Component);

  function ModalDisableCloseOnEsc() {
    _classCallCheck(this, ModalDisableCloseOnEsc);

    var _this = _possibleConstructorReturn(this, (ModalDisableCloseOnEsc.__proto__ || Object.getPrototypeOf(ModalDisableCloseOnEsc)).call(this));
  ...
  _createClass(ModalDisableCloseOnEsc, [{
    key: 'handleOpenModal',
...
exports.default = ModalDisableCloseOnEsc;