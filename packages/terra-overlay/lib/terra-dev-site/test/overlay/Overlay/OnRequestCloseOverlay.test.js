    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          _Overlay2.default,
          { isOpen: this.state.show, isRelativeToContainer: this.state.relative, onRequestClose: this.handleOnRequestESC, id: this.state.id },
          _react2.default.createElement(
            'h3',
            null,
            'The onRequestClose prop gives the overlay close behaviors.'
          ),
          _react2.default.createElement('br', null),
          _react2.default.createElement(
            'p',
            null,
            'Close by clicking inside the overlay or pressing the ESC key.'
          )
        ),
        _react2.default.createElement(
          'button',
