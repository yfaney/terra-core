...
var ImageFluid = function ImageFluid() {
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      'p',
      null,
      'Image width and height are smaller than container. To fill the container, increase the width of the image.'
    ),
    _react2.default.createElement(
      'div',
      { id: 'smaller', style: imagecontainerStyle1 },
      _react2.default.createElement(_Image2.default, { src: _x2.default, alt: 'rounded', variant: 'rounded', isFluid: true })
    ),
    _react2.default.createElement(
      'p',
      null,
