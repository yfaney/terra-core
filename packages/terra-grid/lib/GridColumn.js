...
var _GridModule = require('./Grid.module.scss');

var _GridModule2 = _interopRequireDefault(_GridModule);
...
var cx = _bind2.default.bind(_GridModule2.default);
...
var GridColumn = function GridColumn(_ref) {
  ...
  var colClassNames = cx(['column', (_ref2 = {}, _defineProperty(_ref2, 'column-' + col, col), _defineProperty(_ref2, 'column-tiny-' + tiny, tiny), _defineProperty(_ref2, 'column-small-' + small, small), _defineProperty(_ref2, 'column-medium-' + medium, medium), _defineProperty(_ref2, 'column-large-' + large, large), _defineProperty(_ref2, 'column-huge-' + huge, huge), _ref2), className]);

  return _react2.default.createElement(
    'div',
    _extends({}, customProps, { className: colClassNames }),
    children
  );
};
