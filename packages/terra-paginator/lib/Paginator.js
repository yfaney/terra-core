...
var propTypes = {
   ...
   */
  itemCountPerPage: _propTypes2.default.number
};
  ...
  _createClass(Paginator, [{
    ...
    value: function handleOnKeyDown(index) {
      ...
      return function (event) {
        if (event.nativeEvent.keyCode === _paginationUtils.KEYCODES.ENTER || event.nativeEvent.keyCode === _paginationUtils.KEYCODES.SPACE) {
          ...
          _this3.setState({
            selectedPage: index,
            pageSequence: (0, _paginationUtils.pageSet)(index, (0, _paginationUtils.calculatePages)(_this3.props.totalCount, _this3.props.itemCountPerPage))
          });
        }
    ...
    value: function buildPageButtons(totalPages, onClick) {
      ...
      var _state = this.state,
          pageSequence = _state.pageSequence,
