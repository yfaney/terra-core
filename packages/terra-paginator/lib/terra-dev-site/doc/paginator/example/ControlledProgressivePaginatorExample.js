...
var _ControlledProgressivePaginator = require('terra-paginator/lib/ControlledProgressivePaginator');
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          _terraDialog2.default,
          {
            ...
            footer: _react2.default.createElement(_ControlledProgressivePaginator2.default, { onPageChange: this.changePages, selectedPage: this.state.currentPage, totalCount: totalCount, itemCountPerPage: 10 })
          },
          _react2.default.createElement(
            'div',
            null,
            _react2.default.createElement(_terraButton2.default, { text: 'Set Page to 9', onClick: function onClick() {
                _this2.setState({ currentPage: 9 });
              } }),
            _react2.default.createElement(_terraButton2.default, { text: 'Set Page to 15', onClick: function onClick() {
                _this2.setState({ currentPage: 15 });
              } }),
            _react2.default.createElement(_terraButton2.default, { text: 'Set Page to 45', onClick: function onClick() {
